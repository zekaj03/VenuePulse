                 ...
                 <header className="flex justify-between items-center mb-10 max-w-7xl mx-auto px-2">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <div className="hidden sm:flex items-center gap-2 glass-panel px-3 py-2 rounded-xl border border-white/40 dark:border-white/10">
                         ...
                         {!isPremium && (
                             <button onClick={() => setIsSubscriptionOpen(true)} className="flex items-center gap-2 glass-panel px-3 py-1.5 rounded-full border border-blue-400/50 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 hover:scale-105 transition-transform shadow-lg">
