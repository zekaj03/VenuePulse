                 ...
                 <header className="flex justify-between items-center mb-10 max-w-7xl mx-auto px-2">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <div className="sm:hidden flex items-center gap-2">
                            ...
                            {isPremium ? (
                                <span className="glass-panel inline-flex items-center justify-center w-10 h-10 rounded-xl border border-yellow-400/50 bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20" aria-label={t('subscriptionPremium')}>
                                ...
                                <button
                                    ...
                                    className="glass-panel inline-flex items-center justify-center w-10 h-10 rounded-xl border border-blue-400/50 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 shadow-lg"
